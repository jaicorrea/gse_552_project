...
(Texas, Louisiana, Mississippi) and an indicator for post-2003
(post-\textit{Grutter v.\ Bollinger}). Regressions include controls for
AA-ban policy changes in control states. Cells are weighted by the number
of test-takers. Standard errors (in parentheses) are clustered at the
