...
The point estimates match the paper's Table~1 to three decimal places:
Panel A math coefficient = 8.009 (paper: 8.009) and Panel B math
coefficient = 4.048 (paper: 4.048). The R-squared values and observation
counts are identical. Standard errors are slightly larger than those reported
in the paper (e.g., 1.565 vs.\ 1.544 for Panel A math). This discrepancy
arises because Stata's \texttt{reghdfe} applies a degrees-of-freedom
correction that accounts for the number of absorbed fixed effects when
